...
```{r}
knitr::include_graphics("/home/ron/pneumo_2025_lesserSundas/report/data_cleaning_pictures/Screenshot from 2025-03-30 20-13-27.png")
```
...
I can't trust PathogenWatch's species determination and tehir MLST results, as many species that are *not identified* as pneumococcus (e.g. *Bacillus cereus*, *Haemophillus influenzae*, etc.) have large genome sizes, with many allelic profiles are *simply* denoted as "Novel". This suggest a high possibility of pneumococcus contamination during cultivation.
